...
function Entrenamientos() {
  return (
      <main id="top" className="w-full flex flex-col justify-center items-center sm:pt-0 bg-black">
        {/* HEADER */}
        <div className="w-full h-auto flex max-sm:flex-col justify-center items-center gap-8 pb-16 pt-28 bg-black">
          <div className='p-6'>
            <figure className="size-72 xl:size-[420px] rounded-full  overflow-hidden">
              <img
          ...
          <div className="flex flex-col z-10 w-full max-w-3xl pl-6 pr-6 sm:pl-0 sm:pr-6 xl:pl-0">

            <h1 className="text-3xl sm:text-5xl xl:text-8xl font-bold text-primarylight gap-2 text-pretty">OSCAR ÁVILA</h1>

            
            <h2 className="text-base sm:text-lg xl:text-3xl font-extrabold text-pretty text-white mb-5">ENTRENADOR PERSONAL PROFESIONAL</h2>
            <h3 className="font-normal text-base xl:text-2xl text-pretty text-white">Nuestro servicio de entrenamiento personalizado está diseñado para ayudarte a alcanzar tus objetivos de fitness de manera efectiva y segura. Trabajarás de cerca con nuestro entrenador certificado, Oscar Ávila, quien tiene más de 10 años de experiencia en el campo del fitness.</h3>
            ...
            <ul className="ml-1 sm:ml-0 mt-6 flex gap-6 items-center">
              <li>
                ...
                >
                  ...
                  <svg className="size-9 sm:size-12" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path
                      fillRule="evenodd"
