  ...
  return (
    <section className='w-full sm:h-screen flex justify-center items-center p-6'>
      <div className='flex flex-col sm:flex-row my-20 lg:mt-36 max-w-5xl'>
        ...
        <figure className='flex flex-col sm:w-auto self-center mb-8 lg:mb-0 gap-2 sm:mr-6'>

          <div className='w-auto'>
            <img className='size-full sm:size-[300px]  lg:size-[520px] border shadow-sm animate-fade' src={product?.image[indexOfImageToShow]} alt="" />
          </div>
        ...
        <div className='flex flex-col sm:w-[320px] lg:w-[500px] sm:py-4'>
          <h1 className='text-2xl lg:text-4xl font-extrabold mb-2 text-pretty'>{product?.name} - {product?.brand}</h1>
          <h2 className='text-xl lg:text-2xl font-semibold mb-4 lg:mb-8'>${product?.price} MXN</h2>
          <p className='text-pretty sm:text-xs lg:text-lg mb-12'>{product?.description}</p>
          <div className='flex'>
            <div className='flex mr-4'>
              <button 
                  className='size-10 lg:size-14 border border-gray-300 p-1 flex items-center justify-center hover:text-primarylight hover:border-primarylight' 
                  onClick={()=> {
                    handleDecrement()
                  }}
                >-</button>
                <p className='size-10 font-bold bg-white lg:size-14 flex items-center justify-center border-y border-gray-300 text-xs'>{value}</p>
                <button 
                  className='size-10 lg:size-14 border border-gray-300 p-1 flex items-center justify-center hover:text-green-600 hover:border-green-600' 
                  onClick={()=> {
                    handleIncrement()
            ...
            <button
              ...
              className='w-full bg-primarylight text-white py-2 xl:py-4 px-2 rounded-md font-semibold transition duration-300 ease-in-out hover:bg-primarydark hover:scale-105'
            >
              Agregar al carrito
            </button>
