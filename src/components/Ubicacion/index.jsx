  ...
  return (
    <section className='w-full py-16 px-6 sm:px-16 flex justify-center items-center bg-black bg-opacity-95'>
      <div className='flex flex-col w-full justify-center items-center gap-6 max-w-5xl '>
        <h1 className='text-primarylight text-3xl sm:text-4xl xl:text-4xl font-extrabold sm:mt-0 '>Ubicación y horarios</h1>
        <p className='font-medium text-xl text-white'>Dirección: Blvd Los Reyes 870 , Irapuato Centro, México 📍</p>
