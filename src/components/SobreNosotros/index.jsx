...
function SobreNosotros() {
  return (
    <section className='w-full h-auto xl:h-screen flex justify-center items-center py-10 xl:py-0 px-5 sm:px-16  bg-black bg-opacity-95'>
      <div className='w-full h-full flex flex-col lg:flex-row justify-center items-center p-2'>

        <div className='flex flex-col justify-center items-center lg:w-1/2'>

          <h1 className='text-primarylight text-3xl sm:text-4xl xl:text-4xl 2xl:text-5xl font-extrabold mb-8 lg:mt-0'>Sobre nosotros</h1>

          <p className='w-auto sm:text-xl xl:text-2xl 2xl:text-3xl text-white font-bold sm:pr-5 pb-5 text-pretty'>
        ...
        <div className='flex lg:w-1/2 h-full items-center justify-center'>
          <img className='object-cover' src="../../../public/img/musclefactory/sobre-nosotros-2.jpg" alt="" />
        </div>
